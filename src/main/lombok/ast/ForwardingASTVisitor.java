...
public abstract class ForwardingASTVisitor extends ASTVisitor {
	...
	@Override public boolean visitIdentifierExpression(IdentifierExpression node) {return visitNode(node);}
	...
	@Override public boolean visitIncrementExpression(IncrementExpression node) {return visitNode(node);}
	...
	@Override public boolean visitVariableDeclarationEntry(VariableDeclarationEntry node) {return visitNode(node);}
